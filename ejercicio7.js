...
const videogamesFilterByGender = videogames.filter(
  (game) => (game = game.genders.includes("RPG"))
);

const mediaScore =
  videogamesFilterByGender.reduce((acc, game) => acc + game.score, 0) /
  videogamesFilterByGender.length;
